...
public interface IEventGroupDao {
     ...
     * @return 判断成功
     */
    int create(Connection conn, EventGroup eventGroup);
     ...
     * @param conn 连接
     */
    void insertToAdmin(Connection conn, int userId, EventGroup eventGroup);
     ...
     * @return 判断成功
     */
    int isAdmin(int userId, int eventGroupId);
     ...
     * @return 判断成功
     */
    int delete(Connection conn, String deleteEventGroupName);
     ...
     * @param conn 连接
     */
    void deleteFromAdmin(Connection conn, int eventGroupId, int userId);
     ...
     * @return 瓜圈名
     */
    String queryName(int eventGroupId);
     ...
     * @return 管理的所有瓜圈的id
     */
    List<Integer> findAllOfAdmin(int userId);
     ...
     * @return 该瓜圈id对应的瓜圈
     */
    List<Event> findAllFromGroup(int eventGroupId);
    /**查看瓜圈所属管理员id
     * @param eventGroupId 瓜圈id
     * @return 管理员id
     * */
